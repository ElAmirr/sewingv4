...
export default function App() {
  ...
  return (
    <div className={`app-root ${windowState} ${windowState === 'mini' ? 'mini-zoom-wrapper' : ''}`}>
      {windowState === "mini" && <MiniView />}

      <div className={windowState === 'mini' ? 'mini-content-scaled' : 'full-content'}>
        {!session ? (
          <LoginPage
            onLogin={handleLogin}
            lang={lang}
